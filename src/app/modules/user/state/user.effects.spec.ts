...
describe('User Effects', () => {
    ...
    beforeEach(() => {
        ...
        navigationServiceSpy = jasmine.createSpyObj('NavigationService', ['navigateToProductsPage'])
        snackbarServiceSpy = jasmine.createSpyObj('SnackbarService', ['openErrorMessageBar'])
    ...
    describe('login action', () => {
        ...
        it('should dispatch loginError', () => {
            ...
            effects.login$.subscribe(action => {
                expect(action).toEqual(loginError({ error: JSON.stringify(httpErrorResponse) }));
            });
        });
    ...
    describe('loginSuccess action', () => {
        it('should navigate to the products page', () => {
            ...
            expect(navigationServiceSpy.navigateToProductsPage).toHaveBeenCalledTimes(1);
        });
    });
    ...
    describe('loginError action', () => {
        it('should show wrong credentials ', () => {
            ...
            expect(snackbarServiceSpy.openErrorMessageBar).toHaveBeenCalledOnceWith(SnackbarMessages.wrongCredentials);
        });
        ...
        it('should show server error ', () => {
            ...
            expect(snackbarServiceSpy.openErrorMessageBar).toHaveBeenCalledOnceWith(SnackbarMessages.serverError);
        });
    });
