...
import { addProduct, loadProduct, updateProduct } from '../../../state/product/product.actions';
...
export class ProductsFormComponent implements OnInit {
    ...
    if (!this.isAddMode) {
      ...
      this.store
        ...
        .subscribe((productResponse) =>
          this.productForm.patchValue(productResponse!)
        );
    }
  }
  ...
  private updateProduct() {
    this.store.dispatch(
      updateProduct({
        product: { ...this.productForm.value, id: this.productId },
      })
    );
  }
}
